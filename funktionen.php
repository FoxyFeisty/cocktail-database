...
# Funktion zur Überprüfung eines gültigen Login
function checklogin(){

  # Sitzung übernehmen
  session_start();
  # gibt es keine Sessionvariablen, dann Script abbrechen
  if(!$_SESSION["login"] === true) die("Bitte <a href=\"index.php\">anmelden</a>");
